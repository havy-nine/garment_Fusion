class Config():
    def __init__(self):
        ...
        self.robot_orientation = [0.0, 0.0, 0.0]    # sequence:"XYZ", input degrees, e.g.[0.0, 0.0, 90.0]
        ...
        self.wm_orientation = [0.0, 0.0, 0.0]    # sequence:"XYZ", input degrees, e.g.[0.0, 0.0, 90.0]
        ...
        self.wm_usd_path = "/home/user/garmentIsaac/WashingMachine_usd/washing_machine.usd"

        # ------------Room Config------------ #
        self.room_position = [-3.39737,-1.65851,0.0]   # sequence:"XYZ"

        self.room_orientation = [0.0, 0.0, 0.0]    # sequence:"XYZ", input degrees, e.g.[0.0, 0.0, 90.0]
        ...
        self.busket_orientation = [0.0, 0.0, 90.0]    # sequence:"XYZ", input degrees, e.g.[0.0, 0.0, 90.0]
        ...
        self.base_orientation = [0.0, 0.0, 0.0]    # sequence:"XYZ", input degrees, e.g.[0.0, 0.0, 90.0]
