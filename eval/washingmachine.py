...
class WashingMachineEnv():
    ...
    def pick_multiple_times(self):
        ...
        while(True):
            ...
            # will record the success or failure in data/Record.txt
    ...
    def stir(self,point_cloud,max_value,percentage_below_threshold=None):
        ...
        while continue_stir:
            ...
            if place_percentage_below_threshold > 0.05 or place_max_value - pick_max_value > 0.1 or place_percentage_below_threshold - pick_percentage_below_threshold > 0.02:
                continue_stir=False
