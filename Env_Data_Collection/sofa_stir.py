...
class BaseEnv:
    ...
    def random_pick_place(self):
        ...
        if self.rgb_flag:
            self.point_cloud_camera.get_rgb_graph(
                save_path="Data/Sofa/Stir_Random/rgb/rgb"
            )
        ...
        while distance < 0.15:
            _, self.ply_count = self.point_cloud_camera.save_pc(
                pick_pc,
                pick_color,
                save_path="Data/Sofa/Stir_Random/point_cloud/pointcloud",
            )
            with open("Data/Sofa/Stir_Random/Record.txt", "a") as file:
                file.write(
        ...
        if not fetch_result:
            ...
            with open("Data/Sofa/Stir_Random/Record.txt", "a") as file:
                file.write(
                    f"{pick_point[0]} {pick_point[1]} {pick_point[2]} {place_point[0]} {place_point[1]} {place_point[2]} 0 point_unreachable"
                    + "\n"
                )
            return
        ...
        if self.rgb_flag:
            self.point_cloud_camera.get_rgb_graph(
                save_path="Data/Sofa/Stir_Random/rgb_after_stir/rgb",
                count=self.ply_count,
            )
        _, self.ply_count = self.point_cloud_camera.save_pc(
            pick_pc,
            pick_color,
            save_path="Data/Sofa/Stir_Random/point_cloud_after_stir/pointcloud",
        )
    ...
    def random_pick_model_place(self):
        ...
        _, self.ply_count = self.point_cloud_camera.save_pc(
            pick_pc,
            pick_color,
            save_path="Data/Sofa/Stir_Model/point_cloud/pointcloud",
        )
        if self.rgb_flag:
            self.point_cloud_camera.get_rgb_graph(
                save_path="Data/Sofa/Stir_Model/rgb/rgb"
            )
        ...
        if not fetch_result:
            cprint("fetch current point failed", "red")
            with open("Data/Sofa/Stir_Model/Record.txt", "a") as file:
                file.write(
        ...
        if self.rgb_flag:
            self.point_cloud_camera.get_rgb_graph(
                save_path="Data/Sofa/Stir_Model/rgb_after_stir/rgb",
                count=self.ply_count,
            )
        # save place_pc
        _, self.ply_count = self.point_cloud_camera.save_pc(
            pick_pc,
            pick_color,
            save_path="Data/Sofa/Stir_Model/point_cloud_after_stir/pointcloud",
            count=self.ply_count,
        )
        place_ratio = self.point_cloud_camera.get_pc_ratio()
        cprint(f"place_ratio: {place_ratio}", "cyan")
