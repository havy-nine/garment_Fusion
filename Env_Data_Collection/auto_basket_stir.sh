...
if [ "$random_flag" = "True" ]; then
    TARGET_DIR="Data/Basket/Stir_Random"
else
    TARGET_DIR="Data/Basket/Stir_Model"
fi
...
do
    ~/.local/share/ov/pkg/isaac-sim-2023.1.1/python.sh Env_Data_Collection/basket_stir.py $random_flag $model_path $rgb_flag
    sleep 5
done
