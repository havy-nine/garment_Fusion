...
class Wrap_room:
    def __init__(self, position=torch.tensor, orientation=[0.0, 0.0, 0.0], scale=[1, 1, 1], usd_path=str, prim_path:str="/World/room"):
...
class Wrap_busket:
    def __init__(self, position=torch.tensor, orientation=[0.0, 0.0, 0.0], scale=[1, 1, 1], usd_path=str, prim_path:str="/World/room"):
        ...
        self._busket_prim_path = find_unique_string_name(prim_path,is_unique_fn=lambda x: not is_prim_path_valid(x))
...
class Wrap_base:
    def __init__(self, position=torch.tensor, orientation=[0.0, 0.0, 0.0], scale=[1, 1, 1], usd_path=str, prim_path:str="/World/room"):
        ...
        self._base_prim_path = find_unique_string_name(prim_path,is_unique_fn=lambda x: not is_prim_path_valid(x))
