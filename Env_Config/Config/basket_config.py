...
class Config:
    def __init__(self):
        ...
        # ------------Franka Robot Config------------ #
        self.robot_position = [4.8815, -1.464, 0.33]  # sequence:"XYZ"
        ...
        self.initial_position = [4.85, -1.1, 1.1]
        # ------------wm Config------------ #
        self.wm_position = [5.60, -1.53, 0.45]  # sequence:"XYZ"
        ...
        self.wm_scale = [0.7, 0.7, 0.685]  # sequence:"XYZ", e.g.[1.0, 1.0, 1.0]

        self.wm_prim_path = "/World/Wash_Machine"

        # Washing_Machine_Usd_Path(no need to change)
        self.wm_usd_path = self.path + "/Assets/Wash_Machine/verticle_wash_machine.usd"
        ...
        self.room_usd_path = self.path + "/Assets/Scene/basket_scene/scene.usd"

        # ------------chair Config------------ #
        self.chair_position = [4.847, -0.747, 0.45]  # sequence:"XYZ"
        ...
        self.chair_scale = [0.8, 0.8, 0.8]  # sequence:"XYZ", e.g.[1.0, 1.0, 1.0]

        self.chair_prim_path = "/World/chair"

        # chair_Usd_Path(no need to change)
        self.chair_usd_path = self.path + "/Assets/Chair/Chair.usd"

        # ------------base_layer Config------------ #
        self.base_layer_position = [4.79694, -1.46235, 0.0]  # sequence:"XYZ"
        ...
        self.base_layer_scale = [1.0, 1.0, 1.0]  # sequence:"XYZ", e.g.[1.0, 1.0, 1.0]

        self.base_layer_prim_path = "/World/Base_Layer"

        # base_layer_Usd_Path(no need to change)
        self.base_layer_usd_path = self.path + "/Assets/Robot_Base/base.usd"

        # ------------basket Config------------ #
        self.basket_position = [4.85, -0.82, 0.67]  # sequence:"XYZ"
        ...
        self.point_cloud_camera_position = [4.82, -0.82, 3.15]

        self.point_cloud_camera_orientation = [0, 90, 90]

        # ------------Recording Camera Config------------ #

        self.recording_camera_position = [2.65011, 0.27443, 3.03776]

        self.recording_camera_orientation = [0.0, 40.0, -30.0]
        # ------------Garment Config------------ #
