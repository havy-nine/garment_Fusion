...
class Point_Cloud_Camera:
    ...
    def select_point(self):
        ...
        # Select the top three values and their indices
        topk_values, topk_indices = torch.topk(self.output, 3, dim=1)

        # Select the corresponding three points from the pointcloud
        ...
        # Calculate the distance from these points to the position
    ...
    def get_occlusion(self, id):
        ...
        # Rearrange occlusion according to the indices
    ...
    def analyze_statistics(self, output):
        ...
        bin_centers = 0.5 * (bins[1:] + bins[:-1])  # Center value
