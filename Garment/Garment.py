...
class WrapGarment:
    def __init__(self, stage, scene, garment_num, garment_usd_path_dict, garment_position, garment_orientation, garment_scale,) -> None:
        self.stage = stage
        self.scene = scene
...
'''
class Garment:
    def __init__(self, stage, scene, usd_path, position=torch.tensor, orientation=[0.0, 0.0, 0.0], scale=[1.0, 1.0, 1.0], garment_index=int):
        self.stage = stage
        self.scene = scene
